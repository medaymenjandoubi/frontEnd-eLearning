...
const BecomeInstructor = () => {
    ...
    //becomeInstructor function that will be used when Setup Payout button is clicked
    const BecomeInstructor = () => {
        setLoading(true)
            ...
            <div className="row">
                <div className="col-md-6 offset-md-3 text-center">
                    <div className="pt-4">
                        ...
                        <br />
                        <h2>Setup payout to publish courses on RapydLearn </h2>
                        <p className="lead text-warning">RapydLearn partners with stripe to transfer earnings to your bank account</p>
                        <Button 
                        className="mb-3" 
                        type="primary " 
                        block 
